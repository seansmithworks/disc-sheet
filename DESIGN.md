...
5. **Reveal after settle.** Content and the close control reveal once the surface is within 1% of rest. Items stagger at 90ms, deliberately past the old 30–80ms band (Sean, 2026-09-13) so title, body and actions land as separate beats. The close control's scale-from-0 spin is a deliberate exception to "start at 0.9+", chosen 2026-09-10 for the glyph's symmetry; if it ever reads as popping, that is the first thing to revisit.
